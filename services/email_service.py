...
def send_verification_code(to_email, code, nom=''):
    ...
    mail_from = os.environ.get('MAIL_FROM', 'noreply@stagelinkma.com')

    print(f"[EMAIL] to={to_email} from={mail_from} key={api_key[:8] if api_key else 'MISSING'}...")
